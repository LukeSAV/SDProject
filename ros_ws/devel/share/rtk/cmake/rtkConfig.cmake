...
if("TRUE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/nvidia/SDProject/ros_ws/src/rtk)
  set(rtk_DEVEL_PREFIX /home/nvidia/SDProject/ros_ws/devel)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/nvidia/SDProject/ros_ws/install)
...
if(NOT "/home/nvidia/SDProject/ros_ws/src/rtk/include " STREQUAL " ")
  set(rtk_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/SDProject/ros_ws/src/rtk/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Luke Armbruster <larmbru@purdue.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/SDProject/ros_ws/src/rtk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/SDProject/ros_ws/devel/lib;/home/nvidia/SDProject/ros_ws/devel/lib;/opt/ros/kinetic/lib)
